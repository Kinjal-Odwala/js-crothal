...
var saveWorSummaryComment = function (hcmHouseCode, hcmJob, fscYear, fscPeriod, comment, callback) {
 ...
 var $mop_templates = $(window.__bt__70a800d4[2]);
...
//                me.fireEvent('change', $el.attr('id'), $el.val());
    ...
    var $templates = $(window.__bt__70a800d4[0]);
...
var submitWorItems = function (changes, commentXml, callback) {
    ...
    var WOR = bine.extend(bine.Control, {
        ...
        onDomReady: function () {
            ...
            me.$('#page-status').append('<div id="itemStatusDiv" style="float:none; width:100%"><div class="itemStatusImage Normal" id="itemStatusImage"></div>' +
