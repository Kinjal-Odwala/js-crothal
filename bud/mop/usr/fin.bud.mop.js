...
!function (bud) {
    ...
    var loadMopPeriodItems = function (hcmHouseCode, hcmJob, fscYear, callback) {
        ...
        var innerCallback = function (data) {
            ...
            $('item', $(data)).each(function (index, item) {
                ...
                var dataItem = {
                    fscPeriod: parseInt($item.attr('fscPeriod')), fscAccount: parseInt($item.attr('fscAccount')),
    ...
    var $mop_templates = $(window.__bt__78e071ac[2]);
   ...
   */
    ...
    var $templates = $(window.__bt__78e071ac[0]);
    ...
    bud.page.WOR = function () {
        ...
        var WOR = bine.extend(bine.Control, {
            ...
            saveChanges: function () {
                ...
                $.each(changes, function (index, item) {
                    bine.apply(item, {
                        HcmHouseCode: me.hcmHouseCode, HcmJob: me.hcmJob,
    ...
    bud.page.MOP = bine.extend(bine.Control, {
        ...
        createControls: function () {
            ...
            var showWor = function (fscPeriod, fscAccount) {
                var wor = new bud.page.WOR({
                    hcmHouseCode: me.filter.val('hcmHouseCode'), hcmJob: me.filter.val('hcmJob'), fscYear: me.filter.val('fscYear'),
        ...
        saveChanges: function () {
            ...
            $.each(changes, function (index, item) {
                bine.apply(item, {
                    HcmHouseCode: filter.hcmHouseCode, HcmJob: filter.hcmJob,
