...
var createFscAccountCategoryDataItem = function (fscAccountCategory) {
    ...
    dataItem.SortIndex = FscAccountCategory.OrderIndex.toString().padLeft('0', 4) + '_' + FscAccountCategory.Id.toString().padLeft('0', 4) + '_' + '_9999';
    ...
    var innerCallback = function (data) {
        ...
        $('item', $(data)).each(function (index, item) {
            ...
            */
            ...
            mopCategoryItem['Variance' + periodNumber] += !FscAccount.IsNegative && isRevenueAccount ? -dataItem.mop2Budget : dataItem.mop2Budget;
...
var saveWorSummaryComment = function (hcmHouseCode, hcmJob, fscYear, fscPeriod, comment, callback) {
 ...
 var $mop_templates = $(window.__bt__fb63fadd[2]);
...
MopDataGrid = function () {
    ...
    var $templates = $(window.__bt__fb63fadd[0]);
