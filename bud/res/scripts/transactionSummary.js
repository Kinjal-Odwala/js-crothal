...
Bud.data.AuthorizationStore = WebLight.extend(Bud.data.XmlStore, {
    ...
    loadSampleData: function () {
        this.loadData(_builtInTemplate_10393aa4[0]);
    },
...
Bud.page.TransactionSummaryPage = WebLight.extend(WebLight.Page, {
    ...
    html: _builtInTemplate_10393aa4[1],
    ...
    */
    ...
    createSubGrid: function (data, element) {
        ...
        var getGroupedItem = function (ii) {
            ...
            if (null == item) {
                item = Ext.applyIf({ week1: 0, week2: 0, week3: 0, week4: 0 }, ii);
        ...
        var applyData = function (item1, item2) {
            item1.id = item2.id;
            item1.week1 += item2.week1 || 0;
            item1.week2 += item2.week2 || 0;
            item1.week3 += item2.week3 || 0;
            item1.week4 += item2.week4 || 0;
        };
