...
/****** Object:  View [dbo].[HRCFlow_Combined_EVS_ULEDData_AnnualSummary]    Script Date: 7/9/2018 1:59:08 PM ******/
SET ANSI_NULLS ON
GO
...
CREATE VIEW [dbo].[HRCFlow_Combined_EVS_ULEDData_AnnualSummary] 
AS
/*
Description
--------------------------------------------------------------------------------------------------------------------------------------------------------
This View will return annual summarized combined EVS ULED from HRC and TeamFlow by HouseCode, Functional Area, or steHirNode
*/
