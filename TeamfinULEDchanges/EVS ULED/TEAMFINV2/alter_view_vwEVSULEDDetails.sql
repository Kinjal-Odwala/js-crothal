...
ALTER VIEW [dbo].[vwEVSULEDDetails]  
AS  
...
Description
--------------------------------------------------------------------------------------------------------------------------------------------------------
This EVS view will return the data needed to insert into the ULED Details table
...
SELECT
	...
	case
		when
			(EVS.RequestEnteredBy = Emp.Brief OR EVS.RequestEnteredBy = 'IVR Server')
