...
paf.controller('pafListCtrl', ['$scope', 'EmpActions', '$filter', '$sce', '$modal', function ($scope, EmpActions, $filter, $sce, $modal) {
    ...
    $scope.submit = function (id) {
        EmpActions.submitEmployeePersonnelAction(id, function (data, status) {
            $scope.getPafList();
...
paf.factory('EmpActions', ["$http", "$filter", '$rootScope', function ($http, $filter, $rootScope) {
    ...
    var submitEmployeePersonnelAction = function (id, callback) {
        var xml = '<transaction actionId="' + id + '"><submitEmployeePersonnelAction id="' + id + '" />\r\n</transaction>';
