...
paf.controller('pafListCtrl', ['$scope', 'EmpActions', '$filter', '$sce', function ($scope, EmpActions, $filter, $sce) {
    ...
    $scope.getPafList = function () {
        if ($scope.pafFilter.Date)
            $scope.pafFilter.Date = $filter('date')($scope.pafFilter.Date, 'yyyy-MM-dd')
