...
--Employees\Search
            ...
            Insert Into HirNodeSecuritySetupSources
            values('hourlyOnly', 'HourlyOnly', 'hourlyOnly', 1, 9, '\crothall\chimes\fin\Setup\Employees\Search', (-@@Identity)+@HirNodeIdentity)
            Insert Into HirNodeSecuritySetupSources
            values('salariedOnly', 'SalariedOnly', 'salariedOnly', 1, 9, '\crothall\chimes\fin\Setup\Employees\Search', (-@@Identity)+@HirNodeIdentity)
